...
goog.exportSymbol('proto.ping.Ping', null, global);
 ...
 * @constructor
 */
proto.ping.Ping = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.ping.Ping, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.ping.Ping.displayName = 'proto.ping.Ping';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.ping.Ping.prototype.toObject = function(opt_includeInstance) {
  return proto.ping.Ping.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.ping.Ping} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ping.Ping.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.ping.Ping}
 */
proto.ping.Ping.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ping.Ping;
  return proto.ping.Ping.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.ping.Ping} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ping.Ping}
 */
proto.ping.Ping.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.ping.Ping.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ping.Ping.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.ping.Ping} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ping.Ping.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getText();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.ping.Ping.prototype.getText = function() {
...
/**
 * @param {string} value
 * @return {!proto.ping.Ping} returns this
 */
proto.ping.Ping.prototype.setText = function(value) {
...
proto.ping.PingRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ping: (f = msg.getPing()) && proto.ping.Ping.toObject(includeInstance, f)
  };
...
proto.ping.PingRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.ping.Ping;
      reader.readMessage(value,proto.ping.Ping.deserializeBinaryFromReader);
      msg.setPing(value);
      break;
    default:
      reader.skipField();
...
proto.ping.PingRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.ping.Ping.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.ping.Ping}
 */
proto.ping.PingRequest.prototype.getPing = function() {
  return /** @type{?proto.ping.Ping} */ (
    jspb.Message.getWrapperField(this, proto.ping.Ping, 1));
};


/**
 * @param {?proto.ping.Ping|undefined} value
 * @return {!proto.ping.PingRequest} returns this
*/
proto.ping.PingRequest.prototype.setPing = function(value) {
 ...
 * @return {!proto.ping.PingRequest} returns this
 */
proto.ping.PingRequest.prototype.clearPing = function() {
 ...
 * @return {boolean}
 */
proto.ping.PingRequest.prototype.hasPing = function() {
 ...
 * @return {?proto.ping.Ping}
 */
proto.ping.PingResponse.prototype.getPing = function() {
  return /** @type{?proto.ping.Ping} */ (
    jspb.Message.getWrapperField(this, proto.ping.Ping, 1));
};
...
*/
proto.ping.PingResponse.prototype.setPing = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.ping.PingResponse} returns this
 */
proto.ping.PingResponse.prototype.clearPing = function() {
  return this.setPing(undefined);
};
 ...
 * @return {boolean}
 */
proto.ping.PingResponse.prototype.hasPing = function() {
  return jspb.Message.getField(this, 1) != null;
};
